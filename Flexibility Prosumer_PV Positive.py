...
for i in range(iterations):
    ...
    if i == 47  and counter_PV_positive_flex == 0: # 12 PM PV positive Flexibility Check
    ...
    model_flex.addConstr(P_bat_export <= abs(P_pv_positive_flex[i])) #R10
...
excel_file_path = "Prosumer_Cost_PV_Positive.xlsx"  # Specify the path where you want to save the Excel file
...
plt.title('EMS Robust Optimization with positive PV flexibility provision')
plt.xlabel('Time')
