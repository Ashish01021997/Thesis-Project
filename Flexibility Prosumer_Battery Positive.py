...
plt.title('EMS Robust Optimization with positive Battery flexibility provision')
plt.xlabel('Time')
...
for i in range(iterations):
 ...
 def Bat_Pos_Flex_Price():
        ...
        savings_bat_pos_flex = (P_bat_charging_grid_opt[i] - P_bat_charging_grid_opt_flex[i]) *epex_spot_import_price_flex[i] * time_res
