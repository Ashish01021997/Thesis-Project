...
# Producing Excel file with results of reduced PV scenarios
   ...
   for i in range(96):
       ...
       Load_scenarios[i] = df_reduced_scenarios.iloc[i, 1]  # taking the 2nd scenario

   df_load_scenarios = pd.DataFrame(Load_scenarios)

   excel_file_path = "Load_scenarios_output.xlsx"  # Specify the path where you want to save the Excel file
   df_load_scenarios.to_excel(excel_file_path, index=False)
