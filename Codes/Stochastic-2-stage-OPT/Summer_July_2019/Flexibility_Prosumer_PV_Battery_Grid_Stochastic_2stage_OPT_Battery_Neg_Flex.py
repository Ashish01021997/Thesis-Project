...
class EMS_OPT_Bat_Neg_Flex:
 ...
 def bat_positive_flex(i):  # battery charge from grid
 ...
 def bat_negative_flex(i):  # battery not charging from grid and discharging to grid
 ...
 def PV_positive_flex(i):  # curtailing pv feed in to grid
 ...
 def PV_negative_flex(i):  # not charging battery from PV
 ...
 for i in range(iterations):
   ...
   if i == 12 :  # 3:15 AM Battery -ve  Flexibility Check
        ...
        bat_neg_flex = bat_negative_flex(i)
