...
for i in range(iterations):
    ...
    if i == 37:  # 12:00  PM PV +ve  Flexibility Check
...
for i in range(iterations):
    ...
    if model_flex.status == gp.GRB.OPTIMAL:
        ...
        P_PV_export_grid_opt_flex[i] = -abs(P_PV_export_grid_flex.x + P_pv_positive_flex[i])
        ...
        P_bat_charging_opt_flex[i] = P_bat_charging_PV_flex.x + P_pv_negative_flex[i] - P_pv_positive_flex[i] - P_bat_export.x + P_bat_charging_grid_flex.x - P_bat_positive_flex[i]
