...
for i in range(iterations):
    ...
    if i >= 48  and counter_PV_positive_flex == 0: # 12 PM PV positive Flexibility Check
    ...
    if binary_battery_variable == 1:
        ...
        model_flex.addConstr(
            P_bat_charging_PV_flex == 0.25 * (PV_ninety_percent_quantiles[i] + PV_ten_percent_quantiles[i]) / 2) #R3
    else:
